...
(defmaprules ent->topic
  ...
  (has-one :first-post
           :rules slp.db.maprules/ent->post
           :retriever :topic/first-post)
  (has-one :author
           :rules slp.db.maprules/ent->user
  ...
  (has-many :posts
            ...
            :retriever #(sort-by :post/created-at
                                 (:post/_topic %)))
  (has-many :watches
            :rules slp.db.maprules/ent->watch
...
(defmaprules ent->post
  ...
  (has-one :author
           ...
           :retriever :content/author)
  (has-one :topic
           :rules slp.db.maprules/ent->topic
...
(defmaprules ent->user
  ...
  (has-many :topics
            :rules slp.db.maprules/ent->topic
            :retriever #(slp.db.query/all :topic/title [:content/author (:db/id %)]))
  (has-many :posts
            :rules slp.db.maprules/ent->post
            :retriever (slp.db.maprules/sorted-content :post/content :post/created-at)))
